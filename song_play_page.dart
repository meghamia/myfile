...
class SongPlayPage extends GetView<SongPlayerController> {
                ...
                children: [
                            ...
                            widget: controller.isCloudSoundPlaying
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: NetworkImage(controller.albumUrl),
                                    fit: BoxFit.cover),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () {
                          controller.toggleFavorite(); // Toggle liked state
                        },
                        icon: Icon(
                          controller.isLiked
                              ? Icons.favorite
                          ...
                          color: controller.isLiked
                              ? Colors.redAccent // You can change this color for testing
                              : lableColor,
                        ),
                    ...
                    children: [
                      InkWell(
                        ...
                        child: SvgPicture.asset(
                          ...
                          width: 18,
                          color: controller.isShuffled ? primaryColor : lableColor,
                        ),
                      ),
                      InkWell(
                        onTap: () {
                        ...
                        child: SvgPicture.asset(
                          ...
                          width: 18,
                          color: controller.isLoop ? primaryColor : lableColor,
                        ),
                      ),
                      // SvgPicture.asset(
                      ...
                      //       Get.to(() => LikedSongsPage()); // Use Get.to for navigation
                      //     } else {
                      ...
                      //     width: 18,
                      //     color: controller.isLiked ? Colors.redAccent : lableColor,
                      //   ),
                      // ),
